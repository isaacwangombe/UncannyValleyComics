          ...
          <figcaption className="absolute bottom-8 left-2/4 flex w-[calc(100%-4rem)] -translate-x-2/4 text-left">
            <div>
              ...
              >
                ...
                everything from captivating African comics to iconic titles from
                major publishers like DC and Marvel. Whether you're a fan of
                superheroes, fantasy, or original African stories, we have
            ...
            <figcaption className="absolute bottom-8 left-2/4 flex w-[calc(100%-4rem)] -translate-x-2/4 text-left">
              <div>
                ...
                >
                  ...
                  accessories, inspired by your favorite comics and characters.
                </Typography>
                <Button className="mt-4 ">Read More</Button>
              </div>
            </figcaption>
            ...
            <figcaption className="absolute bottom-8 left-2/4 flex w-[calc(100%-4rem)] -translate-x-2/4 text-left">
              <div>
                ...
                >
                  ...
                  us! We offer the platform and support to bring your unique
                  vision to life.
                </Typography>
                <Button className="mt-4 ">Read More</Button>
              </div>
                ...
                (comic) => (
                  <div key={comic.id}>
                    <Card className="my-4 h-72">
                      ...
                      <IconButton className="card-shopping-cart">
